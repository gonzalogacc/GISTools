...
ver_lista = list(dic_imagenes)
ver_lista.sort()
for i in ver_lista:
	print i
raw_input('Presionar ENTER para iniciar el proceso o Ctrl+C para abortarlo')
...
'''
########################################################################
####### BUGS Y DEPURACIONES PENDIENTES #################################
########################################################################

- ERROR: cuando se encuentran presentes las bandas 'a','b' y 'c' de una 
					imagen, pero se solicita alguna otra, ej 'a','b','d'
